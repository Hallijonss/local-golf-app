// Course facts from GolfBox (skorkort Mosgolf): par 71, CR 68.3, slope ("vægi") 124.
export const courseMeta = { name: 'Mosgolf', par: 71, cr: 68.3, slope: 124 };

// rank = stroke index / forgjafarröð (1 = hardest hole), from the GolfBox scorecard.
